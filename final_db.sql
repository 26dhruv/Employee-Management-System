...
(6, 'dev', 'devmodi@gmail.com', 'Devm@2004', 8980022423, 0, '2023-12-30', '2005-12-31', 1, 1, 1, 2, 2, 2, 1);
...
--
ALTER TABLE `user_education`
  MODIFY `u_edu_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `user_salary`
  MODIFY `sal_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
