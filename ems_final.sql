...
--
-- Dumping data for table `doc_type_master`
--

INSERT INTO `doc_type_master` (`doc_type_id`, `doc_type`) VALUES
(1, 'Adhar'),
(3, 'Pan');
...
INSERT INTO `issue` (`issue_id`, `issue_desc`, `title`, `issue_date`, `issue_status`, `u_id`) VALUES
(4, 'issue', 'fight', '2023-01-01', 3, 6),
(5, 'issue', 'issee', '2023-02-01', 3, 6);
...
INSERT INTO `leave_balance` (`bal_id`, `lv_balance`, `leave_left`, `u_id`, `leave_type_id`) VALUES
(22, 7, 3, 2, 3);
...
INSERT INTO `notification` (`noti_id`, `notifications`, `to_u_id`, `u_id`) VALUES
(14, 'Holiday tom', 2, 1),
(15, 'Test notification', 5, 2),
(16, 'Hello', 0, 2);
...
--
-- Dumping data for table `user_doc_master`
--

INSERT INTO `user_doc_master` (`doc_id`, `doc_no`, `doc`, `u_id`, `doc_type_id`) VALUES
(1, 1234567, 'CE6_NMA-P13,14.pdf', 5, 1);
...
(101, 3, 2, '2023-05-01', '2023-05-05', 4, 'Meet in Gujrat', 2, 'Funds approved');
...
(1, 'Vaibhavi', 'vaibhavi@gmail.com', '$2y$10$4xqzS55/cKgel2YgFuWhluKHBiFO3f3whfawPd0Lw8/UPGBkyumYO', 1234567890, 0, '2023-05-02', '2023-05-03', 1, 1, 1, 1, 1, 1, 1),
(2, 'Dhruvv', 'dhruvkalpeshthakkar@gmail.com', '$2y$10$ANf0f9/T6g61xKVlkQH3E.4qmJLmtPC0xapW.HHDp35w2uvlBcjlq', 8980022422, 0, '2023-05-01', '2005-05-01', 1, 1, 1, 0, 1, 1, 1),
(5, 'Dhrubesh', 'dhruvesh@gmail.com', '$2y$10$w5dzsfPHmyznTFQ2bLvspexxL3CMVyBuFRQi/ajpRwtTREV3AjdOa', 987654321, 0, '2023-12-31', '2004-12-31', 1, 1, 1, 2, 2, 2, 1),
(6, 'dev', 'devmodi@gmail.com', '$2y$10$A/WrUwRbbU/gZlJ60BR5ZuLA7E5scChkLHNTaTBJbr9NMdJ8T5A.m', 8980022423, 0, '2023-12-30', '2005-12-31', 1, 1, 1, 2, 2, 2, 1),
(8, 'xy', 'xyz@gmail.com', '$2y$10$Ad6XgivPi4J5XP2U5e81Qem.t0e/tZ1QV41y4xYKmPtj.th.bjKpu', 8980022426, 0, '2023-12-31', '2005-12-31', 1, 1, 1, 2, 2, 2, 1);
...
(8, 30000, 360000, 1, 1, 1, 1, 1, 1, 345600, 6),
(10, 10000, 120000, 1, 1, 1, 1, 1, 1, 115200, 8);
...
--
-- AUTO_INCREMENT for table `doc_type_master`
--
ALTER TABLE `doc_type_master`
  MODIFY `doc_type_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `issue`
--
ALTER TABLE `issue`
  MODIFY `issue_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `leave_balance`
--
ALTER TABLE `leave_balance`
  MODIFY `bal_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `notification`
  MODIFY `noti_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- AUTO_INCREMENT for table `user_doc_master`
--
ALTER TABLE `user_doc_master`
  MODIFY `doc_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `user_education`
--
ALTER TABLE `user_education`
  MODIFY `u_edu_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `user_leave`
--
ALTER TABLE `user_leave`
  MODIFY `leave_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
...
--
ALTER TABLE `user_salary`
  MODIFY `sal_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- Constraints for table `user_doc_master`
--
ALTER TABLE `user_doc_master`
  ADD CONSTRAINT `user_doc_master_ibfk_1` FOREIGN KEY (`doc_type_id`) REFERENCES `doc_type_master` (`doc_type_id`),
  ADD CONSTRAINT `user_doc_master_ibfk_2` FOREIGN KEY (`u_id`) REFERENCES `user_master` (`u_id`);
