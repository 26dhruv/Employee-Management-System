...
<body>
    ...
    <div class="main">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $cllg_name = $_POST['U_College'];


            $get_dep = "SELECT * FROM `college_master` WHERE `clg_name`='$cllg_name' ";
        ...
        ?> <a href="./AddUniversity.php"></a><?php
                                                ...
                                                $query = "INSERT INTO `college_master` ( `clg_name`,`uni_id`) VALUES ( '$cllg_name','$uni_name');";
    ...
    <form action="./AddCollege.php" method="POST" id="Form">
        <div class="College">
            <input type="text" name="U_College" id="U_College" required maxlength="32" pattern="[a-z\s]{2,32}" title="Must contain only character">
            <span>College</span>
            <i></i>
        </div>
        <div class="University">
            <select name="U_University" id="UNIVERSITY" required>
                <?php
                include "Config.php";
                $query_area = "SELECT * FROM `uni_master`;";
    ...
    <div class="Main_Content">
        <table>
            ...
            <tbody id="table-body">
                ...
                <?php
                include "Config.php";
                $query = "SELECT * FROM `college_master`;";
    ...
    <script>
        ...
        searchInput.addEventListener("input", function() {
            ...
            xhr.open("GET", "search.php?cllg_id=" + encodeURIComponent(query), true);
