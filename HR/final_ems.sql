...
--
-- Host: localhost
-- Generation Time: May 02, 2023 at 06:28 AM
...
(95, 3, 5, '2023-05-02', '2023-05-07', 5, 'Meet in bali', 3, 'Pending');
...
(3, 'infosys', '2023-04-06', '2023-05-01', 200000, 'Sr Developer', 2);
...
--
ALTER TABLE `issue`
  MODIFY `issue_id` int(6) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `leave_balance`
--
ALTER TABLE `leave_balance`
  MODIFY `bal_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `user_leave`
  MODIFY `leave_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
...
--
ALTER TABLE `user_professional_detail`
  MODIFY `prof_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
