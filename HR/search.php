...
if (isset($_GET['q'])) {
...
} else if (isset($_GET['leave_type_id'])) {
    $id1 = $_GET['leave_type_id'];
    $query = "SELECT * FROM `leave_type_master` WHERE leave_type_id LIKE '$id1%';";
    $result = mysqli_query($conn, $query);
    if (!$result) {
        echo "error";
    }
    ...
    $id1 = $_GET['emp_id'];
    $query = "SELECT * FROM `user_master` WHERE u_id LIKE '$id1%' AND role_id=2;";
    $result = mysqli_query($conn, $query);
    if (!$result) {
        echo "";
    }
...
} else if (isset($_GET['Doc_type'])) {
    $id1 = $_GET['Doc_type'];
    $query = "SELECT * FROM `doc_type_master` WHERE doc_type_id LIKE '$id1%';";
    $result = mysqli_query($conn, $query);
    if (!$result) {
        echo "error";
    } else {
